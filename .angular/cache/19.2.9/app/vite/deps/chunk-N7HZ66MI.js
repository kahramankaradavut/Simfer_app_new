  ...
  if (!n || !BUILD.hotModuleReplacement) {
    ...
    switch (a) {
      case "pwa-action-sheet":
        return import("./pwa-action-sheet.entry-UMEMVI3A.js").then(s, consoleError);
      case "pwa-camera-modal":
        return import("./pwa-camera-modal.entry-EQ3JDFQT.js").then(s, consoleError);
      case "pwa-toast":
        return import("./pwa-toast.entry-DIDKELNP.js").then(s, consoleError);
      case "pwa-camera-modal-instance":
        return import("./pwa-camera-modal-instance.entry-ZVUBOOQU.js").then(s, consoleError);
      case "pwa-camera":
        return import("./pwa-camera.entry-2L6K5N4O.js").then(s, consoleError);
    }
  }
...
//# sourceMappingURL=chunk-N7HZ66MI.js.map
