...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorBarcodeScanner/CapacitorBarcodeScanner.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/OSBarcodeLib/OSBarcodeLib.framework"
fi
