...
#ifndef CAPACITORCAMERA_SWIFT_H
#define CAPACITORCAMERA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CapacitorCamera",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("CameraPlugin")
@interface CAPCameraPlugin : CAPPlugin <CAPBridgedPlugin>
...
@interface CAPCameraPlugin (SWIFT_EXTENSION(CapacitorCamera)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate>
